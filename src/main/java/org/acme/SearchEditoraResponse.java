...
@Schema(description = "Estrutura de resposta para buscas paginadas de editoras")
public class SearchEditoraResponse {

    @Schema(description = "Resultados da busca de editoras")
    public List<EditoraRepresentation> results;
    ...
    public static SearchEditoraResponse from(
            List<EditoraRepresentation> results,
            UriInfo uriInfo,
            String q,
            String sort,
            String direction,
        ...
        SearchEditoraResponse response = new SearchEditoraResponse();
